define([ 'underscore', 'jquery', 'config/config','simulate'], function(_, $, config,simulate) {
    /**
     * Service
     * @module service
     * @class service
    ...
    function getWifiBasic() {
        ...
        function prepare(params, isPost) {
            ...
            requestParams.cmd = "RadioOff,m_ssid_enable," + wpapsk + "MAX_Station_num,"+
    ...
    function setWifiSwitch() {
        ...
        function prepare(params) {
            var requestParams = {
                ...
                isTest : isTest,
                wifiEnabled :params.wifi_switch_option
            };
            return requestParams;
        }
     ...
     * @return {Object}
     */
    function setWifiBasicMultiBandSwitch() {
        doStuffAndCheckServerIsOnline(arguments, prepare, deal);

        function prepare(params) {
            var requestParams = {
                goformId : "WIFI_BAND_SWITCH",
                isTest : isTest,
                m_band_enable: params.multi_band_enable
            };
            return requestParams;
        }
    ...
    var loginTimerQueryString = ["signalbar","network_type", "network_provider",
        "ppp_status","EX_SSID1","sta_ip_status","EX_wifi_profile","m_ssid_enable", "RadioOff",
	...
	"data_volume_limit_size","data_volume_alert_percent","data_volume_limit_unit","roam_setting_option","upg_roam_switch","ap_station_mode"];
...
//        }
    ...
    function getWpsInfo() {
        ...
        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.cmd = "WscModeOption,AuthMode,RadioOff,EncrypType,wps_mode,WPS_SSID,m_ssid_enable,SSID1,m_SSID,m_EncrypType,wifi_band,m_wifi_band,m_band_enable";
            requestParams.multi_data = 1;
            return requestParams;
        }
        ...
        function deal(data) {
            if (data) {
                ...
                result.wifiBand = data.wifi_band == 'a' ? 'a' : 'b';
                result.guestWifiBand = data.m_wifi_band == 'a' ? 'a' : 'b';
                result.multi_band_enable = data.m_band_enable;
                return result;
            } else {
                return unknownErrorObject;
            }
    ...
    function getWifiAdvance() {
        ...
        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.cmd = "m_ssid_enable,wan_active_band,m_band_enable,WirelessMode,CountryCode,Channel,HT_MCS,wifi_band,wifi_11n_cap,m_WirelessMode,m_CountryCode,m_Channel,m_wifi_band,m_wifi_11n_cap";
            requestParams.multi_data = 1;
            return requestParams;
        }
        ...
        function deal(data) {
            if (data) {
                var result = {
                    ...
                    multi_band_enable : data.m_band_enable,
                    ...
                    guestMode : data.m_WirelessMode,
                    guestCountryCode : data.m_CountryCode == '' ? 'CN' : data.m_CountryCode,
                    guestChannel : data.m_Channel,
                    guestWifiBand : data.m_wifi_band == 'a' ? 'a' : 'b',
                    guestBandwidth : data.m_wifi_11n_cap
                };
                return result;
            } else {
                return unknownErrorObject;
    ...
    function setWifiAdvanceGuest() {
        ...
        function prepare(params) {
            var requestParams = {
                ...
                isTest : isTest,
                m_WirelessMode : params.m_WirelessMode,
                m_CountryCode : params.m_CountryCode
            };
            if(config.WIFI_BAND_SUPPORT){
                requestParams.m_wifi_band = params.m_wifi_band;
            }
            requestParams.m_Channel = params.m_Channel;
            /*if(!config.WIFI_BAND_SUPPORT || params.wifiBand != 'a'){ // 2.4G
                requestParams.abg_rate = params.rate;
            }*/
            if(config.WIFI_BANDWIDTH_SUPPORT){
                requestParams.m_wifi_11n_cap = params.m_wifi_11n_cap;
            }
            return requestParams;
        }
    ...
    function refreshAPStationStatus() {
        return getAPStationBasic({}, function(data){
            timerInfo.ap_station_enable = data.ap_station_enable;
            timerInfo.ap_station_mode = data.ap_station_mode;
        });
    }
    ...
    function getAPProcess() {
        return doStuff(arguments, {}, prepare, deal, null, false);

        function prepare(params, isPost) {
            var requestParams = {};
            requestParams.isTest = isTest;
            requestParams.cmd = "apsta_startup_flag"
            return requestParams;
        }
        ...
        function deal(data) {
            if (data) {
                var result = {
                    apsta_startup_flag:data.apsta_startup_flag
                };
                return result;
            } else {
                return unknownErrorObject;
	...
	return {
        ...
        setWifiBasicMultiBandSwitch:setWifiBasicMultiBandSwitch,
