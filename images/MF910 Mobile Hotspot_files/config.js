...
define(function() {
	var config = {
        ...
        LOGIN_THEN_CHECK_PIN: false, //是否先登录后验证PIN，PUK
        defaultRoute: '#login',
        LOGIN_SECURITY_SUPPORT: false, //是否支持登录安全
        ...
        IPV4V6_SUPPORT: false, //是否支持ipv4v6。 IPV4V6_SUPPORT和IPV4_AND_V6_SUPPORT不可同时为true.单PDP双栈
        IPV4_AND_V6_SUPPORT: true, //是否支持IPv4 & v6。 双PDP双栈
        USE_IPV6_INTERFACE:true,//使用IPV6相关新接口。使用方法，例如使用MF92时，设置为false。
        MAX_STATION_NUMBER: 14, //WIFI最大连接数
